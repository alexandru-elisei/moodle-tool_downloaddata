...
$string['useoverrides_help'] = 'This allows specific fields to be overwritten. The fields and their values are located in PLUGIN_DIRECTORY/config.php. If the field is not already part of the data, it will be created.';
